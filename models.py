...
class Game(Base):
    ...
    white_prompt: Mapped[str | None] = mapped_column(Text, nullable=True)
    black_prompt: Mapped[str | None] = mapped_column(Text, nullable=True)
    white_session_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
    black_session_id: Mapped[str | None] = mapped_column(String(100), nullable=True)
